...
class JournalEntryPolicy
{
    ...
    {
        return $journalEntry->status_id !== JournalEntryStatusEnum::POSTED
            ? Response::allow()
            : Response::deny('Cannot update a posted journal entry.');
    }
    ...
    public function delete(User $user, JournalEntry $journalEntry): Response
    {
        return $journalEntry->status_id !== JournalEntryStatusEnum::POSTED
            ? Response::allow()
            : Response::deny('Cannot delete a posted journal entry.');
    }
