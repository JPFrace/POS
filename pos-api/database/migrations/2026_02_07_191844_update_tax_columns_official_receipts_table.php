...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::table("official_receipt_details", function (Blueprint $table) {
            ...
            $table->foreignId("sales_tax_account_id")->nullable()->after('withholding_tax_account_id')->constrained('chart_accounts');

            $table->renameColumn("tax_rate", "withholding_tax_rate");
            $table->decimal('sales_tax_rate', 18, 4)->nullable()->after("withholding_tax_rate");
        });
    }
    ...
    public function down(): void
    {
        Schema::table("official_receipt_details", function (Blueprint $table) {
            ...
            $table->dropConstrainedForeignId("sales_tax_account_id");
