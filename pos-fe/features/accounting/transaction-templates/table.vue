<template>
    <AppPageTable endpoint="api/accounting/transaction-templates">
        <template #columns>
            <el-table-column type="selection" width="55" />
            <el-table-column prop="name" label="Name" />
            <el-table-column prop="description" label="Description" />
            <el-table-column prop="is_inactive" label="Status" min-width="30">
            ...
            <el-table-column label="Actions" width="150" class-name="!static">
                <template #default="scope">
                    <div class="space-x-standard">
                        ...
                        <AppPageEdit
                            :id="scope.row.uuid"
                            :endpoint="`api/accounting/transaction-templates/${scope.row.uuid}`"
                            width="80%"
                            width-lg="50%"
                        >
