<template>
    <AppPageTable endpoint="/api/accounting/account-classes">
        <template #columns>
            <el-table-column type="selection" width="55" />
            <el-table-column prop="code" label="Code" width="75" />
            ...
            <el-table-column label="Actions" width="150" class-name="!static">
                <template #default="scope">
                    <div class="space-x-standard">
                        ...
                        <AppPageEdit
                            :id="scope.row.uuid"
                            :endpoint="`/api/accounting/account-classes/${scope.row.uuid}`"
                            width="60%"
                            width-lg="60%"
                        >
