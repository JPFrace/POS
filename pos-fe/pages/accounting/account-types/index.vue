        ...
        <NuxtLayout>
            ...
            <template #toolbarRight>
                <div class="space-x-standard">
                    ...
                    <AppPageDeleteSel
                        endpoint="/api/accounting/account-types/selected"
                    />
                </div>
            </template>
            <div>
...
import Form from "~/features/accounting/account-types/form.vue";
import Table from "~/features/accounting/account-types/table.vue";
...
definePageMeta({
    permission: "Accounting.Account Types.View",
});
</script>
