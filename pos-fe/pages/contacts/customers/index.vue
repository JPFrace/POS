        ...
        <NuxtLayout>
            ...
            <template #toolbarRight>
                <div class="space-x-standard">
                    <AppPageAdd
                        endpoint="/api/contacts/customers"
                        width="70%"
                        width-lg="40%"
                    ...
                    <AppPageDeleteSel
                        endpoint="/api/contacts/customers/selected"
                    />
                </div>
            </template>
            <div>
...
import TableAccess from "~/features/contacts/customers/table.vue";
import { usePageTitle } from "~/composables/usePageTitle";

usePageTitle();
definePageMeta({
    permission: "Contacts.Customers.View",
});
