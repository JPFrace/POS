...
import type {
    ...
    IStep4,
    ICreateAccount,
} from "~/layouts/theme/wizards/create-account-wizard/types";
import CreateAccountStep1 from "~/layouts/theme/wizards/create-account-wizard/steps/CreateAccountStep1.vue";
import CreateAccountStep2 from "~/layouts/theme/wizards/create-account-wizard/steps/CreateAccountStep2.vue";
import CreateAccountStep3 from "~/layouts/theme/wizards/create-account-wizard/steps/CreateAccountStep3.vue";
import CreateAccountStep4 from "~/layouts/theme/wizards/create-account-wizard/steps/CreateAccountStep4.vue";
import CreateAccountStep5 from "~/layouts/theme/wizards/create-account-wizard/steps/CreateAccountStep5.vue";
