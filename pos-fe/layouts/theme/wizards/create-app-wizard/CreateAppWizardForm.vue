<template>
    <!--begin::Form-->
    <form id="kt_create_app_form" class="form" @submit="handleStep">
        <CreateAppStep1 />
        <CreateAppStep2 />
        <CreateAppStep3 />
        <CreateAppStep4 />
...
import type {
    ...
    IStep3,
    IStep4,
} from "~/layouts/theme/wizards/create-app-wizard/types";
import CreateAppStep1 from "~/layouts/theme/wizards/create-app-wizard/steps/CreateAppStep1.vue";
import CreateAppStep2 from "~/layouts/theme/wizards/create-app-wizard/steps/CreateAppStep2.vue";
import CreateAppStep3 from "~/layouts/theme/wizards/create-app-wizard/steps/CreateAppStep3.vue";
import CreateAppStep4 from "~/layouts/theme/wizards/create-app-wizard/steps/CreateAppStep4.vue";
import CreateAppStep5 from "~/layouts/theme/wizards/create-app-wizard/steps/CreateAppStep5.vue";
