...
import Dropdown2 from "~/layouts/theme/dropdown/Dropdown2.vue";
        ...
        const items = [
            ...
            },
            {
                ...
                table: [
                    ...
                    {
                        agent: {
                            avatar: "~/assets/media/avatars/300-24.jpg",
                            name: "Esther Howard",
                            city: "Mexico",
                        },
                        price: "74.83",
                    ...
                    {
                        agent: {
                            avatar: "~/assets/media/avatars/300-17.jpg",
            ...
            },
            {
                ...
                table: [
                    ...
                    {
                        agent: {
                            avatar: "~/assets/media/avatars/300-21.jpg",
                    ...
                    {
                        agent: {
                            avatar: "~/assets/media/avatars/300-30.jpg",
                            name: "Jacob Jones",
                            city: "PManila",
                        },
                        price: "88.56",
                    ...
                    {
                        agent: {
                            avatar: "~/assets/media/avatars/300-14.jpg",
                            name: "Esther Howard",
                            city: "Iceland",
                        },
                        price: "63.16",
