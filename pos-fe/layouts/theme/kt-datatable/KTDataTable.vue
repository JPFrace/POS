...
import TableContent from "~/layouts/theme/kt-datatable/table-partials/table-content/TableContent.vue";
import TableFooter from "~/layouts/theme/kt-datatable/table-partials/TableFooter.vue";
        ...
        const dataToDisplay = computed(() => {
            if (props.data) {
                if (props.data.length <= itemsInTable.value) {
                    ...
                    const sliceFrom =
                        (currentPage.value - 1) * itemsInTable.value;
