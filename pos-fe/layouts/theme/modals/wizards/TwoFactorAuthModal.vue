                            ...
                            >
                                ...
                                <span class="d-block fw-semibold text-start">
                                    ...
                                    <span class="text-gray-500 fw-semibold fs-6"
                                        >We will send a code via SMS if you need
                    ...
                    >
                        ...
                        <div class="text-gray-500 fw-semibold fs-6 mb-10">
                            ...
                            <a
                                ...
                                target="_blank"
                                >1Password</a
                            >, scan the QR code. It will generate a 6 digit code
                            ...
                            <div class="d-flex flex-stack flex-grow-1">
                                ...
                                <div class="fw-semibold">
                                    <div class="fs-6 text-gray-600">
                                        If you having trouble using the QR code,
                                        select manual entry on your app, and
        ...
        const submitMobileForm = () => {
            ...
            setTimeout(() => {
                if (submitMobileButtonRef.value) {
                    ...
                    submitMobileButtonRef.value?.removeAttribute(
                        "data-kt-indicator"
                    );
                }
